...
class PageMatchs extends StatefulWidget {
  const PageMatchs({
    Key? key,
  }) : super(key: key);

  @override
  _StateMatchs createState() => _StateMatchs();
}

class _StateMatchs extends AuthState<PageMatchs>
    with SingleTickerProviderStateMixin {
  int filterChange = null;
  String search = '0';
  String cMSKey = 'filter';
  String cMSValue = 'matchs';
  int changePage = null;
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: PageCARTEMatchs(
                                            ...
                                            jeu: datasets['Cms fetch']?[index]
                                                    ?['jeu'] ??
                                                '',
                                            nomMatch: datasets['Cms fetch']
                                                    ?[index]?['nom_match'] ??
                                                '',
                                            caster: datasets['Cms fetch']
                                                    ?[index]?['Caster(s)'] ??
                                                '',
                                            dateMatch: datasets['Cms fetch']
                                                    ?[index]?['date_match'] ??
                                                '',
                                            image: datasets['Cms fetch']?[index]
                                                    ?['image'] ??
                                                '',
                                          ),
                                        ),
